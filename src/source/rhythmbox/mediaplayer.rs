//! This code was autogenerated with `dbus-codegen-rust -d org.mpris.MediaPlayer2.rhythmbox -p /org/mpris/MediaPlayer2`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
...
pub trait OrgMprisMediaPlayer2Playlists {
    ...
    fn active_playlist(&self) -> Result<(bool, (dbus::Path<'static>, String, String,),), dbus::Error>;
}

impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgMprisMediaPlayer2Playlists for blocking::Proxy<'a, C> {
    ...
    fn playlist_count(&self) -> Result<u32, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.mpris.MediaPlayer2.Playlists", "PlaylistCount")
    }

    fn orderings(&self) -> Result<Vec<String>, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.mpris.MediaPlayer2.Playlists", "Orderings")
    }

    fn active_playlist(&self) -> Result<(bool, (dbus::Path<'static>, String, String,),), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.mpris.MediaPlayer2.Playlists", "ActivePlaylist")
    }
}
