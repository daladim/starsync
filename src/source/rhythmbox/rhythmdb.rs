//! This code was autogenerated with `dbus-codegen-rust -d org.mpris.MediaPlayer2.rhythmbox -p /org/gnome/Rhythmbox3/RhythmDB`, see https://github.com/diwic/dbus-rs
...
pub trait OrgGnomeRhythmbox3RhythmDB {
    fn get_entry_properties(&self, uri: &str) -> Result<arg::PropMap, dbus::Error>;
    fn set_entry_properties(&self, uri: &str, properties: arg::PropMap) -> Result<(), dbus::Error>;
}

impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgGnomeRhythmbox3RhythmDB for blocking::Proxy<'a, C> {

    fn get_entry_properties(&self, uri: &str) -> Result<arg::PropMap, dbus::Error> {
        self.method_call("org.gnome.Rhythmbox3.RhythmDB", "GetEntryProperties", (uri, ))
            .and_then(|r: (arg::PropMap, )| Ok(r.0, ))
    }

    fn set_entry_properties(&self, uri: &str, properties: arg::PropMap) -> Result<(), dbus::Error> {
        self.method_call("org.gnome.Rhythmbox3.RhythmDB", "SetEntryProperties", (uri, properties, ))
    }
}
